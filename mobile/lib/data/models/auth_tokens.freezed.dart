...
class _$AuthTokensImpl implements _AuthTokens {
  ...
  @override
  String toString() {
    return 'AuthTokens(accessToken: $accessToken, refreshToken: $refreshToken, accessTokenExpiresAt: $accessTokenExpiresAt, refreshTokenExpiresAt: $refreshTokenExpiresAt)';
  }
...
abstract class _AuthTokens implements AuthTokens {
  const factory _AuthTokens(
      ...
      required final DateTime refreshTokenExpiresAt}) = _$AuthTokensImpl;

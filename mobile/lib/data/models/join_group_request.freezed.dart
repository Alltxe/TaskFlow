...
class _$JoinGroupRequestImpl implements _JoinGroupRequest {
  const _$JoinGroupRequestImpl({required this.inviteToken});
  ...
  @override
  String toString() {
    return 'JoinGroupRequest(inviteToken: $inviteToken)';
  }
...
abstract class _JoinGroupRequest implements JoinGroupRequest {
  const factory _JoinGroupRequest({required final String inviteToken}) =

...
class _$RewardImpl implements _Reward {
  ...
  @override
  String toString() {
    return 'Reward(id: $id, name: $name, description: $description, cost: $cost, isActive: $isActive, imageUrl: $imageUrl, createdAt: $createdAt, groupId: $groupId, createdById: $createdById)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, description, cost,
      isActive, imageUrl, createdAt, groupId, createdById);
...
abstract class _Reward implements Reward {
  const factory _Reward(
      ...
      required final String createdById}) = _$RewardImpl;

...
abstract class $UpdateProfileRequestCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String? username, String? avatarUrl, bool? isAway, DateTime? awayUntil});
}
...
class _$UpdateProfileRequestImpl implements _UpdateProfileRequest {
  const _$UpdateProfileRequestImpl(
      {this.username, this.avatarUrl, this.isAway, this.awayUntil});
  ...
  @override
  String toString() {
    return 'UpdateProfileRequest(username: $username, avatarUrl: $avatarUrl, isAway: $isAway, awayUntil: $awayUntil)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, username, avatarUrl, isAway, awayUntil);
...
abstract class _UpdateProfileRequest implements UpdateProfileRequest {
  const factory _UpdateProfileRequest(
      ...
      final String? avatarUrl,
      final bool? isAway,
      final DateTime? awayUntil}) = _$UpdateProfileRequestImpl;
